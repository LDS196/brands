...
import {setSort, SortType} from "components/Redux/Slices/FilterSlice";
import {sortItems} from "components/Redux/Slices/ProdutsSlice";

export const list = [
    {name: 'price(desc)', sortProp: 'price'},
    {name: 'price(ask)', sortProp: '-price'},
    {name: 'alphabet(desc)', sortProp: 'title'},
    {name: 'alphabet(ask)', sortProp: '-title'},
]
export const Sort = () => {
